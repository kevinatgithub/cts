            ...
            <div class="main-timeline7">
                ...
                <div class="timeline" v-for="(timeline, i) in timelines" :key="i">
                    ...
                    <div class="timeline-content">
                        ...
                        <div class="name lead">{{timeline.name}}</div>
                        <div class="description">
                            <span class="small text-success"><i :class="'fa fa-' + timeline.icon"></i>&nbsp;{{timeline.description}}</span>
                        </div>
...
.main-timeline7 .year{display:block;padding:0 60px 0 30px;font-size:12px;color:#303a3b;text-align:right;border-bottom:2px solid #303a3b;z-index:2;position:relative}
...
.main-timeline7 .timeline-content:after,.main-timeline7 .timeline-content:before{content:"";width:80px;height:0;border-radius:50%;background:#000;position:absolute;top:-7%;right:15px;z-index:-1}
