<template>
    <div>
        <b-card bg-variant="dark" text-variant="white" title="Cryobox Details" v-if="!cryobox">
            <b-card-text>
                <i class="fa fa-info-circle"></i> Cryobox Location not set
            </b-card-text>
            <b-button variant="success" size="sm" v-b-modal.cryobox-selector>Set Cryobox Location</b-button>
        </b-card>
        <b-card v-if="cryobox">
