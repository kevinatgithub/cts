<template>
    <div>
        <table class="table table-sm">
            <tbody>
                <tr>
                    <th style="width:150px;">BSF Machine</th>
                    <th><b class="text-danger">{{machineName}}</b></th>
                    <th style="width:150px;">BSF Med Tech</th>
                    <th><b class="text-danger">{{referral.results.bsf.bsf_mt}}</b></th>
                    <th style="width:150px;">Proficiency License</th>
                    <th><b class="text-danger">{{referral.results.bsf.hiv_license}}</b></th>
                </tr>
            </tbody>
        </table>
        <table class="table table-sm">
